...
protocol ReferralPopupDelegate {
    func getStarted()
}

class ReferralPopup: UIView {
    ...
    var delegate: ReferralPopupDelegate?
    ...
    private func setup() {
        let nib =  UINib(nibName: "ReferralPopup", bundle: Bundle(for: type(of: self)))
