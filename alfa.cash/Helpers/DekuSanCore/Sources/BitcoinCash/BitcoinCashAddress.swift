...
public struct BitcoinCashAddress: DecuSanAddress, Equatable {
    ...
    public static func cashAddrDecode(string: String) -> (Data, String)? {
        ...
        var hrp: NSString?
        guard let data = DekuSanCrypto.cashAddrDecode(value, hrp: &hrp),
    ...
    public var description: String {
        return DekuSanCrypto.cashAddrEncode(data, hrp: hrp)
    }

    public func toBitcoinAddress() -> DecuSanBitcoinAddress {
        let bc = BitcoinCash()
        ...
        return DecuSanBitcoinAddress(data: Data([prefix]) + data.dropFirst())!
    }
}
