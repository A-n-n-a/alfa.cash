...
public struct TronContract {
    ...
    public func contract() throws -> Protocol_Transaction.Contract {
        ...
        case .transferContract(let from, let to, let amount):
            ...
            transferContract.ownerAddress = DekuSanCrypto.base58Decode(from.description)!
            transferContract.toAddress = DekuSanCrypto.base58Decode(to.description)!
        ...
        case .transferAssetContract(let from, let to, let amount, let assetName):
            ...
            transferAssetContract.ownerAddress = DekuSanCrypto.base58Decode(from.description)!
            transferAssetContract.toAddress = DekuSanCrypto.base58Decode(to.description)!
