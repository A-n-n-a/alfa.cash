...
public extension Bitcoin {
    func build(to: DecuSanAddress, amount: Int64, fee: Int64, changeAddress: DecuSanAddress, utxos: [BitcoinUnspentTransaction]) throws -> BitcoinTransaction {
    ...
    func buildScript(for address: DecuSanAddress) -> BitcoinScript? {
        if let bitcoinAddress = address as? DecuSanBitcoinAddress {
