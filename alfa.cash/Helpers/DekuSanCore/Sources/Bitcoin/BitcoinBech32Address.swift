...
public struct BitcoinBech32Address: DecuSanAddress, Equatable {
    // bech32 data
    ...
    public static func bech32Decode(string: String) -> (Data, String)? {
        var hrp: NSString?
        guard let data = DekuSanCrypto.bech32Decode(string, hrp: &hrp),
    ...
    public var description: String {
        return DekuSanCrypto.bech32Encode(data, hrp: hrp)
    }
}
